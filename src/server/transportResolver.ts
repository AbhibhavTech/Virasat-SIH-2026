...
// -------------------------------------------------------------
// Verified Station Aliases & Lookup Helper
// -------------------------------------------------------------
export const STATION_ALIASES: Record<
  string,
  { name: string; code: string; city: string; state: string; lat?: number; lng?: number }
> = {
  csmt: { name: 'Chhatrapati Shivaji Maharaj Terminus (CSMT)', code: 'CSMT', city: 'Mumbai', state: 'Maharashtra', lat: 18.94, lng: 72.8353 },
  cst: { name: 'Chhatrapati Shivaji Maharaj Terminus (CSMT)', code: 'CSMT', city: 'Mumbai', state: 'Maharashtra', lat: 18.94, lng: 72.8353 },
  mumbaicsmt: { name: 'Chhatrapati Shivaji Maharaj Terminus (CSMT)', code: 'CSMT', city: 'Mumbai', state: 'Maharashtra', lat: 18.94, lng: 72.8353 },
  churchgate: { name: 'Churchgate Railway Station (CCG)', code: 'CCG', city: 'Mumbai', state: 'Maharashtra', lat: 18.9322, lng: 72.8264 },
  churchgatestation: { name: 'Churchgate Railway Station (CCG)', code: 'CCG', city: 'Mumbai', state: 'Maharashtra', lat: 18.9322, lng: 72.8264 },
  ccg: { name: 'Churchgate Railway Station (CCG)', code: 'CCG', city: 'Mumbai', state: 'Maharashtra', lat: 18.9322, lng: 72.8264 },
  ...
  dadar: { name: 'Dadar Junction (DR)', code: 'DR', city: 'Mumbai', state: 'Maharashtra', lat: 19.0178, lng: 72.8478 },
  dr: { name: 'Dadar Junction (DR)', code: 'DR', city: 'Mumbai', state: 'Maharashtra', lat: 19.0178, lng: 72.8478 },
  bandraterminus: { name: 'Bandra Terminus (BDTS)', code: 'BDTS', city: 'Mumbai', state: 'Maharashtra', lat: 19.0617, lng: 72.8406 },
  bdts: { name: 'Bandra Terminus (BDTS)', code: 'BDTS', city: 'Mumbai', state: 'Maharashtra', lat: 19.0617, lng: 72.8406 },
  lokmanyatilakterminus: { name: 'Lokmanya Tilak Terminus (LTT)', code: 'LTT', city: 'Mumbai', state: 'Maharashtra', lat: 19.0694, lng: 72.8906 },
  ltt: { name: 'Lokmanya Tilak Terminus (LTT)', code: 'LTT', city: 'Mumbai', state: 'Maharashtra', lat: 19.0694, lng: 72.8906 },
  ndls: { name: 'New Delhi Railway Station (NDLS)', code: 'NDLS', city: 'Delhi', state: 'Delhi', lat: 28.643, lng: 77.2195 },
  delhistation: { name: 'New Delhi Railway Station (NDLS)', code: 'NDLS', city: 'Delhi', state: 'Delhi', lat: 28.643, lng: 77.2195 },
  newdelhistation: { name: 'New Delhi Railway Station (NDLS)', code: 'NDLS', city: 'Delhi', state: 'Delhi', lat: 28.643, lng: 77.2195 },
  dli: { name: 'Old Delhi Railway Station (DLI)', code: 'DLI', city: 'Delhi', state: 'Delhi', lat: 28.6619, lng: 77.228 },
  ...
  howrah: { name: 'Howrah Junction (HWH)', code: 'HWH', city: 'Kolkata', state: 'West Bengal', lat: 22.5833, lng: 88.3425 },
  ...
  sealdah: { name: 'Sealdah Railway Station (SDAH)', code: 'SDAH', city: 'Kolkata', state: 'West Bengal', lat: 22.5684, lng: 88.3712 },
  sdah: { name: 'Sealdah Railway Station (SDAH)', code: 'SDAH', city: 'Kolkata', state: 'West Bengal', lat: 22.5684, lng: 88.3712 },
  njp: { name: 'New Jalpaiguri Junction (NJP)', code: 'NJP', city: 'Siliguri', state: 'West Bengal', lat: 26.6853, lng: 88.4419 },
  dj: { name: 'Darjeeling Railway Station (DJ)', code: 'DJ', city: 'Darjeeling', state: 'West Bengal', lat: 27.041, lng: 88.2663 },
  sina: { name: 'Srinagar Railway Station (SINA)', code: 'SINA', city: 'Srinagar', state: 'Jammu and Kashmir', lat: 34.0384, lng: 74.8384 },
  srinagarstation: { name: 'Srinagar Railway Station (SINA)', code: 'SINA', city: 'Srinagar', state: 'Jammu and Kashmir', lat: 34.0384, lng: 74.8384 },
  svdk: { name: 'Shri Mata Vaishno Devi Katra (SVDK)', code: 'SVDK', city: 'Katra', state: 'Jammu and Kashmir', lat: 32.9856, lng: 74.9547 },
  katrastation: { name: 'Shri Mata Vaishno Devi Katra (SVDK)', code: 'SVDK', city: 'Katra', state: 'Jammu and Kashmir', lat: 32.9856, lng: 74.9547 },
  jat: { name: 'Jammu Tawi (JAT)', code: 'JAT', city: 'Jammu', state: 'Jammu and Kashmir', lat: 32.7058, lng: 74.8789 },
  jammustation: { name: 'Jammu Tawi (JAT)', code: 'JAT', city: 'Jammu', state: 'Jammu and Kashmir', lat: 32.7058, lng: 74.8789 },
  klk: { name: 'Kalka Railway Station (KLK)', code: 'KLK', city: 'Kalka', state: 'Haryana', lat: 30.8358, lng: 76.9366 },
  ...
  asr: { name: 'Amritsar Junction (ASR)', code: 'ASR', city: 'Amritsar', state: 'Punjab', lat: 31.634, lng: 74.8723 },
  amritsarstation: { name: 'Amritsar Junction (ASR)', code: 'ASR', city: 'Amritsar', state: 'Punjab', lat: 31.634, lng: 74.8723 },
  ...
  goastation: { name: 'Madgaon Junction (MAO)', code: 'MAO', city: 'Goa', state: 'Goa', lat: 15.2736, lng: 73.9678 },
  ...
  rnc: { name: 'Ranchi Junction (RNC)', code: 'RNC', city: 'Ranchi', state: 'Jharkhand', lat: 23.35, lng: 85.33 },
  ranchistation: { name: 'Ranchi Junction (RNC)', code: 'RNC', city: 'Ranchi', state: 'Jharkhand', lat: 23.35, lng: 85.33 },
  dhn: { name: 'Dhanbad Junction (DHN)', code: 'DHN', city: 'Dhanbad', state: 'Jharkhand', lat: 23.7985, lng: 86.4244 },
  dhanbadstation: { name: 'Dhanbad Junction (DHN)', code: 'DHN', city: 'Dhanbad', state: 'Jharkhand', lat: 23.7985, lng: 86.4244 },
  jsme: { name: 'Jasidih Junction (JSME)', code: 'JSME', city: 'Deoghar', state: 'Jharkhand', lat: 24.5167, lng: 86.65 },
  deogharstation: { name: 'Jasidih Junction (JSME)', code: 'JSME', city: 'Deoghar', state: 'Jharkhand', lat: 24.5167, lng: 86.65 },
};

export function findStationByQuery(
  query: string
): { name: string; code: string; city: string; state: string; lat?: number; lng?: number } | null {
  if (!query) return null;
  initializeTransportRegistry();
  const cleanQ = query.toLowerCase().replace(/[^a-z0-9]/g, '');

  if (STATION_ALIASES[cleanQ]) {
    return STATION_ALIASES[cleanQ];
  }

  // Look in MASTER_VERIFIED_STATIONS
  const byCode = MASTER_VERIFIED_STATIONS.find(
    (s) => s.code && s.code.toLowerCase() === cleanQ
  );
  if (byCode) {
    return { name: byCode.name, code: byCode.code, city: bybyCodeCity(byCode), state: byCode.state, lat: byCode.lat, lng: byCode.lng };
  }

  const byName = MASTER_VERIFIED_STATIONS.find(
    (s) => s.name.toLowerCase().replace(/[^a-z0-9]/g, '') === cleanQ
  );
  if (byName) {
    return { name: byName.name, code: byName.code, city: bybyCodeCity(byName), state: byName.state, lat: byName.lat, lng: byName.lng };
  }

  return null;
}

function bybyCodeCity(s: VerifiedStationNode): string {
  return s.city || '';
}
