...
export const INDIA_PINS: MapPinData[] = [
  ...
  {
    id: 'gujarat',
    name: 'Gujarat (Statue of Unity & Rani ki Vav)',
    type: 'town',
    stateId: 'gujarat',
    townId: 'patan',
    stateName: 'Gujarat',
    region: 'Western India',
    iconicPlace: 'Statue of Unity & Rani ki Vav',
    lat: 21.8380,
    lng: 73.7191,
    thumbnail: '/images/gujarat-statue-of-unity-4k.jpg',
  },
  {
    id: 'maharashtra',
  ...
  {
    id: 'andhra-pradesh',
    name: 'Andhra Pradesh (Tirupati & Lepakshi)',
    type: 'town',
    stateId: 'andhra-pradesh',
    townId: 'tirupati',
    stateName: 'Andhra Pradesh',
    region: 'Southern India',
    iconicPlace: 'Tirumala Venkateswara Temple & Lepakshi',
    lat: 13.6288,
    lng: 79.4192,
    thumbnail: '/images/andhra-pradesh-tirumala-4k.jpg',
  },
  {
    id: 'telangana',
  ...
  },
  {
    ...
    stateName: 'Assam',
    region: 'Northeastern India',
    iconicPlace: 'Brahmaputra Valley Tea Gardens & Kaziranga',
    lat: 26.9535,
    lng: 94.2188,
    thumbnail: '/images/assam-tea-plantation-4k.jpg',
  },
  {
    id: 'meghalaya',
