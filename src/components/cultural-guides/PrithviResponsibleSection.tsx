...
import { Heart, Sparkles, Footprints, ShoppingBag, Calendar, Landmark, Accessibility, ArrowRight } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8">
        ...
        <div className="flex flex-wrap gap-2 shrink-0">
          ...
          >
            ...
            <span>Support Heritage Preservation</span>
          </button>
          <button
