...
export const GUIDE_CHARACTERS: Record<GuideCharacterId, GuideCharacterInfo> = {
  yatri: {
    ...
    role: 'Primary Virasat travel companion guiding curiosity, exploration, and discovery across India.',
    ...
    quickActions: [
      ...
      { label: 'Ask Virasat AI', actionType: 'ai', payload: 'What are the top must-visit heritage landmarks in India?' },
  ...
  safar: {
    ...
    quickActions: [
      { label: 'Plan City Itinerary', actionType: 'navigate', payload: 'itinerary' },
      { label: 'Interactive Travel Map', actionType: 'navigate', payload: 'map' },
      { label: 'UNESCO Heritage Sites', actionType: 'navigate', payload: 'heritage' },
    ],
  },
  rasika: {
    id: 'rasika',
    ...
    quickActions: [
      { label: 'Explore India Destinations', actionType: 'navigate', payload: 'india' },
      { label: 'Major Heritage Sites', actionType: 'navigate', payload: 'heritage' },
      { label: 'Regional Flavors & Living Arts', actionType: 'ai', payload: 'What are the authentic culinary and craft specialties of this region?' },
    ],
  },
  khoj: {
    id: 'khoj',
    ...
    quickActions: [
      ...
      { label: 'Explore Offbeat Gems', actionType: 'navigate', payload: 'india' },
  ...
  prithvi: {
    ...
    quickActions: [
      { label: 'AI Trip Planner', actionType: 'navigate', payload: 'itinerary' },
      { label: 'Explore Interactive Map', actionType: 'navigate', payload: 'map' },
...
export const CITY_GUIDE_RECOMMENDATIONS: Record<string, CityGuideRecommendation[]> = {
  mumbai: [
    ...
    },
    {
      city: 'Mumbai',
      guideId: 'safar',
      highlightTitle: 'Mumbai Suburban Transit & Routes',
      highlightDescription: 'Western & Central lines moving 7.5 million daily commuters. Connect seamlessly between historic terminals and suburban hubs.',
      actionLabel: 'Explore Mumbai Circuit Map',
      targetTab: 'map',
    ...
    },
    {
      ...
      actionLabel: 'Plan Green Day Trip',
      targetTab: 'itinerary',
      tags: ['Zero Emission E-cycles', 'Protected Forest', 'Forest Canopy'],
    },
  ],
  delhi: [
    {
    ...
    },
    {
      ...
      actionLabel: 'View On Interactive Map',
      targetTab: 'map',
    ...
    },
    {
      city: 'Delhi',
      guideId: 'prithvi',
      highlightTitle: 'Eco-Battery Rickshaws & Red Fort Green Transit',
      highlightDescription: 'Clean electric transit and solar rickshaws linking Chandni Chowk with Red Fort and Jama Masjid entrance pavilions.',
      actionLabel: 'Plan Eco Itinerary',
      targetTab: 'itinerary',
      tags: ['Solar Rickshaws', 'Clean Energy Zone', 'Electric Transit'],
    },
  ],
  jaipur: [
    {
