  ...
  const getCityConfig = (city: string): CityLayerConfig => {
    ...
    if (c.includes('lonavala') || c.includes('khandala') || c.includes('lonavla')) {
      return {
        ...
        subtext: 'Dramatic cliff drops at Tiger’s Leap and Duke’s Nose, cascading waterfalls at Bhushi Dam & Kune, ancient rock-cut Chaitya halls at Karla & Bhaja, and Shivaji Maharaj ramparts at Lohagad & Rajmachi Forts.',
        backdropImage: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=1600&auto=format&fit=crop&q=85',
        accentBadge: 'Sahyadri Hill Forts & Caves Hub',
        heritageSymbol: 'Karla Caves • Lohagad Fort • Tiger’s Leap • Bhushi Dam',
        guideQuote: 'The monsoon clouds billow over Tiger’s Leap and Duke’s Nose, while ancient monks carved sacred prayer halls into these sheer basalt cliffs over 2,200 years ago.',
        guideCharacter: 'prithvi',
        dominantPalette: 'from-emerald-900/40 via-stone-900/30 to-[#FAF8F5]',
      };
    }
    ...
    if (c.includes('varanasi')) {
      return {
        ...
        backdropImage: '/images/varanasi-ganga-aarti.jpg',
