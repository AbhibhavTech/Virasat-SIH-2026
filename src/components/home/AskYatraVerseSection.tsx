...
interface AskVirasatSectionProps {
  onOpenAIChat?: (prompt?: string) => void;
  onNavigateTab: (tab: NavTab) => void;
  selectedCity?: string;
}

export const AskVirasatSection: React.FC<AskVirasatSectionProps> = ({
  onOpenAIChat,
  onNavigateTab,
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-base text-stone-600 max-w-xl mx-auto leading-relaxed">
              Tell Virasat what kind of experience you're looking for.
            </p>
          </div>
