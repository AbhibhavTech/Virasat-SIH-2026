  ...
  const cards = [
    {
      ...
      title: 'Major Monuments & Famous Places',
      desc: 'Explore India’s globally renowned monuments, iconic tourist places, and world-famous heritage sites.',
      icon: Landmark,
      color: 'text-amber-600',
      badge: 'Famous Sites Only',
      badgeClass: 'bg-amber-50 text-amber-800 border-amber-200',
    },
    {
      tab: 'itinerary' as NavTab,
      title: 'AI City Trip Planner',
      desc: 'Cozy day-by-day smart itineraries grouping verified attractions, timing, and nearby heritage markets.',
      icon: Calendar,
      color: 'text-sky-600',
      badge: 'Cozy & Verified',
