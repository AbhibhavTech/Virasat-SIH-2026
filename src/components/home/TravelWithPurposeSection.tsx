...
import { Leaf, Heart, Calendar, Landmark, Users, ArrowRight } from 'lucide-react';
...
export const TravelWithPurposeSection: React.FC<TravelWithPurposeSectionProps> = ({
  ...
  const pillars = [
    ...
    {
      icon: Calendar,
      title: 'Mindful Day Planning',
      desc: 'Paced schedules with balanced transit, gentle timings, and neighborhood exploration.',
      action: () => onNavigateTab('itinerary'),
      linkText: 'Plan with AI',
    },
    {
      icon: Landmark,
      title: 'Heritage Preservation',
      desc: 'Protect fragile ancient masonry and discover UNESCO-inscribed monument circuits across India.',
      action: () => onNavigateTab('heritage'),
