...
const HERO_HERITAGE_SLIDES: HeroHeritageSlide[] = [
  ...
  },
  {
    ...
    state: 'Maharashtra',
    category: 'Colonial Indo-Saracenic Landmark',
    tag: 'Harbour Arch of Mumbai',
    builtEra: '1911–1924 CE • George Wittet',
    bestTime: 'Sunrise & Evening Sunset',
    rating: '4.8',
    reviewsCount: '52.1k',
    imageUrl: 'https://images.unsplash.com/photo-1570168007204-dfb528c6958f?w=1600&auto=format&fit=crop&q=85',
    fallbackUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Gateway_of_India_Mumbai.jpg/1280px-Gateway_of_India_Mumbai.jpg',
  },
  {
    id: 'shaniwar-wada',
    name: 'Shaniwar Wada',
    location: 'Pune City',
    state: 'Maharashtra',
    category: 'Peshwa Imperial Fortification',
    tag: 'Citadel of the Maratha Empire',
    builtEra: '1732 CE • Peshwa Baji Rao I',
    bestTime: 'Morning 9:00 AM – 1:00 PM',
    rating: '4.7',
    reviewsCount: '29.3k',
    imageUrl: 'https://images.unsplash.com/photo-1600100397608-f010e421e4a3?w=1600&auto=format&fit=crop&q=85',
    fallbackUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/Shaniwarwada_pune.jpg/1280px-Shaniwarwada_pune.jpg',
  },
  {
    id: 'meenakshi-temple',
    ...
    location: 'Madurai',
    state: 'Tamil Nadu',
    category: 'Living Dravidian Temple Complex',
    tag: 'Soaring Sculpted Gopurams',
    builtEra: '1623–1655 CE • Nayak Dynasty',
    bestTime: 'Early Morning & Evening Aarti',
    rating: '4.9',
    reviewsCount: '62.4k',
    imageUrl: 'https://images.unsplash.com/photo-1600100397608-f010f443b780?w=1600&auto=format&fit=crop&q=85',
    fallbackUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/be/Meenakshi_Amman_Temple_Madurai.jpg/1280px-Meenakshi_Amman_Temple_Madurai.jpg',
  },
  {
    id: 'kangra-fort',
    name: 'Kangra Fort',
    ...
    category: 'Ancient Himalayan Hill Fort',
    tag: 'Oldest Dated Fort in India',
    builtEra: '4th Century BCE • Katoch Dynasty',
    bestTime: 'Morning 9:00 AM – 3:00 PM',
    rating: '4.7',
    reviewsCount: '18.7k',
    imageUrl: 'https://images.unsplash.com/photo-1597074866923-dc0589150358?w=1600&auto=format&fit=crop&q=85',
    fallbackUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/20/Kangra_Fort_HP.jpg/1280px-Kangra_Fort_HP.jpg',
  },
];
