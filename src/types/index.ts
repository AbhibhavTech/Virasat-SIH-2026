import { EntityImageMetadata, ImageRecordMeta } from './database';
...
export interface LocationSuggestion {
  ...
  name: string;
  code?: string;
  type?: 'station' | 'heritage' | 'place' | 'city' | 'hotel' | 'festival';
  categoryType: 'station' | 'heritage' | 'place' | 'city' | 'hotel' | 'festival';
  city?: string;
  state?: string;
  lat: number;
  lng: number;
