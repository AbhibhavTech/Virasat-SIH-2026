...
export const FavoritesPage: React.FC<FavoritesPageProps> = ({
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      {loading ? (
        <div className="text-center py-20 text-xs text-[#046A38] font-semibold animate-pulse">
        ...
        <div className="text-center py-20 rounded-3xl bg-white border border-[#EFE8DF] p-8 space-y-3 shadow-sm">
          ...
          {onNavigateTab && (
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-[#FF671F] hover:bg-[#E65100] text-white text-xs font-bold transition shadow-sm mt-2"
            >
            ...
            >
              <div className="relative h-48 overflow-hidden bg-slate-100">
                ...
                <button
                  ...
                  className="absolute top-3 right-3 p-2 rounded-2xl bg-white/90 backdrop-blur-md text-rose-600 hover:bg-white border border-[#EFE8DF] transition shadow-xs"
              ...
              <div className="p-5 space-y-3 flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-base font-bold text-slate-900 group-hover:text-[#046A38] transition line-clamp-1">
                    {p.name}
                  </h3>
                ...
                <div className="pt-3 border-t border-slate-100 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 text-xs font-bold text-[#046A38] hover:underline"
                  >
