...
export const MyTripsPage: React.FC<MyTripsPageProps> = ({ onNavigateTab, onSelectPlace }) => {
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      {loading ? (
        <div className="text-center py-16 text-xs text-[#046A38] font-semibold animate-pulse">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5">
                  {trip.stops?.map((stop, idx) => (
                    <div
                      ...
                      className="p-3 rounded-2xl bg-slate-50 border border-[#EFE8DF] flex items-center justify-between text-xs cursor-pointer hover:border-emerald-400 transition"
                    >
