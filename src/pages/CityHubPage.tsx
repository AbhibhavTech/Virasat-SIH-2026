    ...
    <div className="space-y-6 w-full animate-fadeIn pb-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <button
          ...
          className="p-3.5 rounded-2xl bg-gradient-to-r from-orange-500 to-amber-600 text-white shadow-xs hover:shadow-md transition flex items-center justify-between text-left group cursor-pointer"
        >
          <div>
        ...
        <button
          ...
          className="p-3.5 rounded-2xl bg-gradient-to-r from-emerald-600 to-teal-700 text-white shadow-xs hover:shadow-md transition flex items-center justify-between text-left group cursor-pointer"
        >
          <div>
        ...
        <button
          ...
          className="p-3.5 rounded-2xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white shadow-xs hover:shadow-md transition flex items-center justify-between text-left group cursor-pointer"
        >
          <div>
        ...
        <button
          ...
          className="p-3.5 rounded-2xl bg-gradient-to-r from-rose-500 to-pink-600 text-white shadow-xs hover:shadow-md transition flex items-center justify-between text-left group cursor-pointer"
        >
          <div>
        ...
        <div className="space-y-4">
          ...
          {festivals.length === 0 ? (
            <div className="p-8 rounded-2xl bg-amber-50/70 border border-amber-200 text-center space-y-2">
              ...
              <button
                onClick={() => onNavigateTab('festivals')}
                className="mt-3 px-4 py-2 rounded-xl bg-orange-500 hover:bg-orange-600 text-white text-xs font-bold cursor-pointer"
              >
                ...
                >
                  ...
                  <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-100">
                      <button
                        onClick={() => onNavigateTab('map')}
                        className="py-1.5 px-2 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-700 text-xs font-bold flex items-center justify-center gap-1 transition cursor-pointer"
                      >
                      ...
                      <button
                        onClick={() => onNavigateTab('itinerary')}
                        className="py-1.5 px-2 rounded-xl bg-orange-50 hover:bg-orange-100 border border-orange-200 text-orange-700 text-xs font-bold flex items-center justify-center gap-1 transition cursor-pointer"
                      >
              ...
              {hotels.map((h) => (
                ...
                >
                  ...
                  <div className="pt-2 border-t border-slate-100 flex items-center justify-between">
                    ...
                    <button
                      onClick={() => onNavigateTab('map')}
                      className="px-3 py-1.5 rounded-xl bg-indigo-50 hover:bg-indigo-100 border border-indigo-200 text-indigo-700 text-xs font-bold flex items-center gap-1 transition cursor-pointer"
                    >
          ...
          {activeCategory === 'all' && festivals.length > 0 && (
            <div className="p-4 rounded-2xl bg-gradient-to-r from-orange-50 to-amber-50 border border-orange-200 shadow-2xs flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <button
                ...
                className="px-3.5 py-1.5 rounded-xl bg-orange-600 hover:bg-orange-700 text-white text-xs font-bold shrink-0 transition cursor-pointer"
              >
