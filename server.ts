...
const CITY_ALIASES: Record<string, string[]> = {
  ...
  sambalpur: ['sambalpur'],
  'sawai-madhopur': ['sawai madhopur', 'sawaimadhopur', 'ranthambore'],
  chittorgarh: ['chittorgarh', 'chittor'],
  pushkar: ['pushkar'],
  'mount-abu': ['mount abu', 'mountabu'],
  bikaner: ['bikaner'],
  srinagar: ['srinagar'],
  ...
  tirupati: ['tirupati', 'tirumala', 'tirumala venkateswara'],
  srikalahasti: ['srikalahasti', 'kalahasti'],
  'araku-valley': ['araku-valley', 'araku valley', 'araku', 'borra caves', 'borra'],
  ...
  sullurpeta: ['sullurpeta', 'sullurpet', 'pulicat'],
  kondapalli: ['kondapalli'],
  guwahati: ['guwahati', 'gauhati', 'dispur'],
  mayong: ['mayong', 'pobitora'],
  kohora: ['kohora', 'kaziranga'],
  bansbari: ['bansbari', 'manas'],
  orang: ['orang'],
  bhalukpong: ['bhalukpong', 'nameri'],
  majuli: ['majuli', 'majuli island'],
  sivasagar: ['sivasagar', 'sibsagar'],
  sonari: ['sonari', 'charaideo'],
  haflong: ['haflong'],
  tawang: ['tawang', 'tawang monastery', 'sela pass', 'sela lake', 'bum la'],
  dirang: ['dirang'],
  bomdila: ['bomdila'],
  ziro: ['ziro', 'ziro valley'],
  miao: ['miao', 'namdapha'],
  jengging: ['jengging', 'mouling'],
  itanagar: ['itanagar', 'ita fort', 'ganga lake'],
  mechuka: ['mechuka', 'menchukha'],
  pasighat: ['pasighat'],
  kufri: ['kufri'],
  manali: ['manali', 'solang', 'solang valley', 'rohtang', 'hadimba'],
  kasol: ['kasol'],
  barshaini: ['barshaini', 'kheerganga'],
  dharamshala: ['dharamshala', 'dharamsala'],
  'mcleod-ganj': ['mcleod-ganj', 'mcleod ganj', 'mcleodganj', 'triund'],
  khajjiar: ['khajjiar'],
  dalhousie: ['dalhousie'],
  chail: ['chail'],
  kullu: ['kullu'],
  kaza: ['kaza', 'spiti', 'spiti valley'],
  munnar: ['munnar'],
  alappuzha: ['alappuzha', 'alleppey', 'marari'],
  thiruvananthapuram: ['thiruvananthapuram', 'trivandrum', 'kovalam'],
  varkala: ['varkala'],
  thekkady: ['thekkady', 'periyar'],
  wayanad: ['wayanad', 'edakkal'],
  athirappilly: ['athirappilly', 'athirapally'],
  kumarakom: ['kumarakom'],
  kozhikode: ['kozhikode', 'calicut'],
  bekal: ['bekal'],
  'silent-valley': ['silent-valley', 'silent valley'],
  sabarimala: ['sabarimala'],
  thattekad: ['thattekad'],
  tripunithura: ['tripunithura'],
  tsomgo: ['tsomgo', 'changu', 'nathu la', 'nathula'],
  lachung: ['lachung', 'yumthang', 'zero point'],
  lachen: ['lachen', 'gurudongmar'],
  pelling: ['pelling', 'khecheopalri'],
  agartala: ['agartala', 'ujjayanta'],
  melaghar: ['melaghar', 'neermahal', 'rudrasagar'],
  kailashahar: ['kailashahar', 'unakoti'],
  bishalgarh: ['bishalgarh', 'sepahijala'],
  'jampui-hills': ['jampui-hills', 'jampui hills', 'jampui'],
  rishikesh: ['rishikesh'],
  haridwar: ['haridwar', 'har ki pauri'],
  mussoorie: ['mussoorie'],
  nainital: ['nainital', 'naini lake'],
  ramnagar: ['ramnagar', 'corbett', 'jim corbett'],
  ghangaria: ['ghangaria', 'valley of flowers', 'hemkund'],
  kedarnath: ['kedarnath'],
  badrinath: ['badrinath'],
  gangotri: ['gangotri'],
  'janki-chatti': ['janki-chatti', 'janki chatti', 'yamunotri'],
  auli: ['auli'],
  ...
  landour: ['landour'],
  tehri: ['tehri', 'tehri lake', 'new tehri'],
  // Nagaland
...
function loadData() {
  try {
    ...
    loadPlacesFile(path.join(dataDir, 'assam', 'places.json'));
    loadPlacesFile(path.join(dataDir, 'arunachal-pradesh', 'places.json'));
